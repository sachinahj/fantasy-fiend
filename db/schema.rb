...
ActiveRecord::Schema.define(version: 20140729153303) do
  ...
  create_table "season2013_stats", force: true do |t|
    t.integer  "player_id"
  ...
  add_index "season2013_stats", ["player_id"], name: "index_season2013_stats_on_player_id"

  create_table "season2014_projections", force: true do |t|
    t.integer  "player_id"
  ...
  add_index "season2014_projections", ["player_id"], name: "index_season2014_projections_on_player_id"
